...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        User user = new User();
        user.setUserName("IMT2020019");
        user.setUserPassword(getEncodedPassword("Manish@369"));
        user.setUserFirstName("Manish Reddy");
        user.setUserLastName("Koppula");

        user.setStatus("VERIFIED");
        user.setMailID("Manish.koppula@iiitb.ac.in");
